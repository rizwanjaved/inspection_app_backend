        ...
        <div class=" col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-offset-1 col-10 middle mx-auto">
            <div class="error-container">
                <div class="error-main">
                    <h1> <i class="livicon" data-name="success" data-s="100" data-c="#ffbc60" data-hc="#ffbc60" data-eventtype="click" data-iteration="15" data-duration="2000"></i>
                        200
                    </h1>
                    <h3>
                           Forgeot Password Request Proceed !
                    </h3>
                    <!-- <a href="{{ route('home') }}">
